...
AddressBus::AddressBus(Cartridge& card,
    ...
    _mem_map = {
        ...
        {"io_ports", 0xFF10, 0xFF12, NotImplementedGet, NotImplementedSet},
        {"nr13_freq_lo",
         0xFF13,
         0xFF13,
         NotImplementedGet,
        ...
        {"io_ports", 0xFF15, 0xFF17, NotImplementedGet, NotImplementedSet},
        {"nr23_freq_lo",
         0xFF18,
         0xFF18,
         NotImplementedGet,
        ...
        {"nr30_on_off",
         0xFF1A,
         0xFF1A,
         [&](uint16_t) { return _snd.wave_output().nr30_active(); },
         [&](uint16_t, byte x) { _snd.wave_output().set_nr30_active(x); }},
        {"nr31_length",
         0xFF1B,
         0xFF1B,
         [&](uint16_t) { return _snd.wave_output().nr31_length(); },
         [&](uint16_t, byte x) { _snd.wave_output().set_nr31_length(x); }},
        {"nr32_level",
         0xFF1C,
         0xFF1C,
         [&](uint16_t) { return _snd.wave_output().nr32_level(); },
         [&](uint16_t, byte x) { _snd.wave_output().set_nr32_level(x); }},
        {"nr33_freq_lo",
         0xFF1D,
         0xFF1D,
         NotImplementedGet,
         [&](uint16_t, byte x) { _snd.wave_output().set_nr33_freq_lo(x); }},
        {"nr34_freq_hi",
         0xFF1E,
         0xFF1E,
         [&](uint16_t) { return _snd.wave_output().nr34_freq_hi(); },
         [&](uint16_t, byte x) { _snd.wave_output().set_nr34_freq_hi(x); }},
